...
public class AddressRepositoryTests {
	...
	public void testAddNew() {
		...
		newAddress.setFirstName("Abhi");
		newAddress.setLastName("Raipurkar");
		newAddress.setPhoneNumber("09372457845");
		newAddress.setAddressLine1("2222 Near Hall town");
		newAddress.setCity("Mumbai");
		newAddress.setState("Maharastra");
		newAddress.setPostalCode("4411111");
