...
public class CustomerRepositoryTests {
	...
	public void testCreateCustomer1() {
		...
		customer.setEmail("Rutuja31.com");
	...
	public void testUpdateAuthenticationType() {
		Integer id =3 ;
		repo.updateAuthenticationType(id,com.shopme.common.entity.AuthenticationType.FACEBOOK);

		Customer customer = repo.findById(id).get();

		assertThat(customer.getAuthenticationType()).isEqualTo(com.shopme.common.entity.AuthenticationType.FACEBOOK);
	}
